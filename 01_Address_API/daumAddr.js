(function () {
    ...
    window.daum = window.daum || {},
        function (a) {
            ...
            a.postcode.version = "210331", a.postcode.load = function (a) {
    ...
    ! function (a, b, c, d, e) {
        ...
        function h(a, b) {
            ...
            if (b) {
                var d = b.popupName;
                d && "string" == typeof d && "" !== m.trim(d) && (c = m.extend(a, {
                    popupName: d
                }))
            }
            return c
        ...
        function i(a, b) {
            ...
            if (b) {
                var d = b.autoClose;
                void 0 !== d && null !== d && "boolean" == typeof d && (c = m.extend(a, {
                    autoClose: d
                }))
            }
            return c
        ...
        var l = function (a) {
                ...
                return function () {
                    return b ? !1 : (alert("[�고렪踰덊샇 �쒕퉬��] API 濡쒕뵫�� �덉슜�섏� �딆� �뚮씪誘명꽣媛� 媛먯��섏뼱 API �묐룞�� 以묒��섏뿀�듬땲��. �ъ씠�� 愿�由ъ옄遺꾧퍡�쒕뒗 媛��대뱶�섏씠吏�( https://postcode.map.daum.net/guide )�� 湲곕낯 �ъ슜踰뺤쓣 李멸퀬�섏떆�� �섏젙 遺��곷뱶由쎈땲��."), console && "function" == typeof console.error && console.error("[�고렪踰덊샇 �쒕퉬��] API 濡쒕뵫�� �덉슜�섏� �딆� �뚮씪誘명꽣媛� 媛먯��섏뼱 API �묐룞�� 以묒��섏뿀�듬땲��. �ъ씠�� 愿�由ъ옄遺꾧퍡�쒕뒗 媛��대뱶�섏씠吏�( https://postcode.map.daum.net/guide )�� 湲곕낯 �ъ슜踰뺤쓣 李멸퀬�섏떆�� �섏젙 遺��곷뱶由쎈땲��."), !0)
                }
            }(k),
            m = b,
            n = a.CONT,
        ...
        q.init(x, v, w), j.prototype = {
            open: function (a) {
                if (!l()) {
                    ...
                    b = f(b, a), b = g(b, a), b = h(b, a), b = i(b, a), b = m.extend(b, {
                        viewType: "popup"
                    }), q.popup.create(b)
                }
            },
